...
parser = argparse.ArgumentParser(description="Train the residual quadrotor model")
...
model = ResidualQuadModel(hidden_dim=64, num_layers=5, dt=dt).to(device)
print("🧠 Initialized ResidualQuadModel")
...
wandb_run = init_wandb_run(
    ...
    tags=["residual", *train_trajs],
    group=f"residual__{'_'.join(train_trajs)}",
)
